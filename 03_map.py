...
class MapViz:
    ...
    def draw_data(self, x, y, abbrev, index):
        ...
        percent = py5.norm(value, self.data_min, self.data_max)
        between_ptr = py5.lerp_color("#FF4422", "#4422CC", percent)
        between_btg = py5.lerp_color("#296F34", "#61E2F0", percent, py5.HSB)
        
        py5.fill(between_btg)
